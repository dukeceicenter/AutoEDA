...
def calc_codebleu(
    ...
    # Convert scores from 0-1 range to 0-100 range (standard BLEU convention)
    return {
        "codebleu": code_bleu_score * 100,
        "ngram_match_score": ngram_match_score * 100,
        "weighted_ngram_match_score": weighted_ngram_match_score * 100,
        "syntax_match_score": syntax_match_score * 100,
        "dataflow_match_score": dataflow_match_score * 100,
    }
